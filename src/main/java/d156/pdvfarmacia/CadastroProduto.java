    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"0001", "Advil", "20"},
                {"0002", "Allegra", "25"},
                {"0003", "Barra de Cereal", "15"},
                {"0004", "Chocolate Zero", "10"},
                {"0005", "Condicionador", "15"},
                {"0006", "Creme Hidratante", "15"},
                {"0007", "Delineador Preto", "12"},
                {"0008", "Dipirona", "20"},
                {"0009", "Epocler", "30"},
                {"0010", "Escova de Dente", "15"},
                {"0011", "Esmalte", "10"},
                {"0012", "Esmalte", "14"},
                {"0013", "Fini", "14"},
                {"0014", "Fralda", "30"},
                {"0015", "Halls", "20"},
                {"0016", "Lenço Umedecido", "15"},
                {"0017", "Manteiga de Cacau", "25"},
                {"0018", "Máscata para Cílios", "15"},
                {"0019", "Merthiolate", "25"},
                {"0020", "Monster", "15"},
                {"0021", "Novalgina", "25"},
                {"0022", "Óleo para Cabelo", "10"},
                {"0023", "Sabonete", "25"},
                {"0024", "Shampoo", "20"},
                {"0025", "Trident", "36"},
                {"0026", null, null},
